...
public class AdditonalPurchaseTest extends BaseTest{
	...
	public static LoginRegister userlogin= new LoginRegister();
	  ...
	  @Test(priority=1) public void gaolButton() throws InterruptedException {
	 userlogin.additionalPurchaseLogin();
	  ...
	  @Test(priority=2) public void additinalPurchaseTest() throws
	  InterruptedException { additional.investButton();
