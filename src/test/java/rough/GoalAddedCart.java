...
public class GoalAddedCart {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath(
				...
				.sendKeys("test27apr22@gmail.com");
		driver.findElement(By.xpath(
...
//One Time
		...
		driver.findElement(By
				.xpath("/html/body/div[1]/div/div[2]/div/div/div/div[2]/div[1]/div/md-card/md-card-actions/button[2]"))
				.click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("/html/body/div[4]/md-dialog/md-dialog-content[2]/div[8]/md-input-container/input"))
				.sendKeys("5100");
		Thread.sleep(3000);
...
//Monthly
		Thread.sleep(3000);
		driver.findElement(By
				.xpath("/html/body/div[1]/div/div[2]/div/div/div/div[2]/div[1]/div/md-card/md-card-actions/button[1]"))
				.click();

		Thread.sleep(3000);

		List<WebElement> list3 = driver.findElements(By.xpath(
				"/html/body/div[5]/md-dialog/md-dialog-content/div[5]/md-input-container/md-select/md-select-value/span[2]"));
		list3.get(0).click();
		Thread.sleep(3000);
		...
		List<WebElement> list4 = driver.findElements(By.xpath(
				"/html/body/div[5]/md-dialog/md-dialog-content/div[6]/md-input-container/md-select/md-select-value/span[2]"));
		list4.get(0).click();
		Thread.sleep(3000);
...
//Add More schemeButton	
		...
		driver.findElement(By.xpath("//span[contains(text(),'Add More Scheme')]")).click();
		/*
		 * //Goal Button Thread.sleep(5000);
		 * driver.findElement(By.linkText("Goals")).click(); Thread.sleep(4000);
		 * driver.findElement(By.xpath(
		 * "/html/body/div[1]/div/div[2]/div/div/div/div/div/div/div[5]/div[2]/a/h4")).
		 * click();
		 */
...
//Search Scheme button
		Thread.sleep(4000);
		driver.findElement(By.xpath(
				"/html/body/div[1]/div/div[2]/div/div/div/div[2]/div[4]/div/md-card/md-card-content/md-card-title/md-card-title-text/a"))
				.click();
		Thread.sleep(3000);
		...
		List<WebElement> list001 = driver.findElements(By.xpath(
				"/html[1]/body[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[3]/md-input-container[1]/md-select[1]"));
		list001.get(0).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html/body/div[7]/md-select-menu/md-content/md-option[1]")).click();
		Thread.sleep(3000);
		driver.findElement(
				By.xpath("/html[1]/body[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[4]/button[1]/span[1]"))
				.click();
...
//Monthly Added in cart
		...
		List<WebElement> lista = driver.findElements(By.xpath(
				"/html/body/div[7]/md-dialog/md-dialog-content/div[5]/md-input-container/md-select/md-select-value/span[1]/div"));
		lista.get(0).click();
		...
		List<WebElement> listb = driver.findElements(By.xpath(
				"/html/body/div[7]/md-dialog/md-dialog-content/div[6]/md-input-container/md-select/md-select-value/span[2]"));
		listb.get(0).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html/body/div[9]/md-select-menu/md-content/md-option[9]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html/body/div[7]/md-dialog/md-dialog-content/div[8]/md-input-container/input"))
				.sendKeys("1200");
		Thread.sleep(3000);
		driver.findElement(By.xpath("//span[contains(text(),'Add to cart')]")).click();
		Thread.sleep(3000);
...
//One Time 
		Thread.sleep(5000);
		driver.findElement(By
				.xpath("/html/body/div[1]/div/div[2]/div/div/div/div[2]/div[2]/div/md-card/md-card-actions/button[2]"))
				.click();
		Thread.sleep(4000);
		driver.findElement(By.xpath("/html/body/div[7]/md-dialog/md-dialog-content/div[8]/md-input-container/input"))
				.sendKeys("5001");
