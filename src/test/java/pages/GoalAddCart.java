...
public class GoalAddCart extends BaseTest {
	...
	public void searchSchMonthly() throws InterruptedException {
		...
		List<WebElement> lista = driver.findElements(By.xpath(
				"/html/body/div[8]/md-dialog/md-dialog-content/div[5]/md-input-container/md-select/md-select-value"));
		lista.get(0).click();
		...
		List<WebElement> listb = driver.findElements(By.xpath(
				"/html/body/div[8]/md-dialog/md-dialog-content/div[6]/md-input-container/md-select/md-select-value"));
		listb.get(0).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html/body/div[10]/md-select-menu/md-content/md-option[39]/div")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html/body/div[8]/md-dialog/md-dialog-content/div[8]/md-input-container/input"))
				.sendKeys("5001");
		Thread.sleep(3000);
		driver.findElement(By.xpath("//span[contains(text(),'Add to cart')]")).click();
		Thread.sleep(3000);
