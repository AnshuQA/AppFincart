...
public class PaymentGetway extends BaseTest {
	public void paymentContinueBtn() throws InterruptedException {
		Thread.sleep(4000);
		driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div/div/div/div[2]/md-toolbar[1]/div/button"))
				.click();
	}
	...
	public void netBanking() throws InterruptedException {
		...
		driver.findElement(By.xpath(
				"/html[1]/body[1]/md-bottom-sheet[1]/div[2]/md-list[1]/md-list-item[1]/div[1]/div[1]/md-checkbox[1]/div[1]"))
				.click();
		Thread.sleep(3000);
	...
	public void otherCard() throws InterruptedException {
		Thread.sleep(4000);
		driver.findElement(By.xpath(
				"/html[1]/body[1]/md-bottom-sheet[1]/div[2]/md-list[1]/md-list-item[2]/div[1]/div[1]/md-checkbox[1]/div[1]"))
				.click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html[1]/body[1]/md-bottom-sheet[1]/div[3]/button[1]")).click();
		Thread.sleep(10000);
	...
	public void masterDebitCard() throws InterruptedException {
		Thread.sleep(4000);
		driver.findElement(By.xpath(
				"/html[1]/body[1]/md-bottom-sheet[1]/div[2]/md-list[1]/md-list-item[3]/div[1]/div[1]/md-checkbox[1]/div[1]"))
				.click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html[1]/body[1]/md-bottom-sheet[1]/div[3]/button[1]")).click();
		Thread.sleep(10000);
	...
	public void visaDebitCart() throws InterruptedException {
		Thread.sleep(4000);
		driver.findElement(By.xpath(
				"/html[1]/body[1]/md-bottom-sheet[1]/div[2]/md-list[1]/md-list-item[4]/div[1]/div[1]/md-checkbox[1]/div[1]"))
				.click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html[1]/body[1]/md-bottom-sheet[1]/div[3]/button[1]")).click();
		Thread.sleep(10000);
	...
	public void upi() throws InterruptedException {
		Thread.sleep(4000);
		driver.findElement(By.xpath(
				"//body/md-bottom-sheet[1]/div[2]/md-list[1]/md-list-item[3]/div[1]/div[1]/md-checkbox[1]/div[1]"))
				.click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html[1]/body[1]/md-bottom-sheet[1]/div[3]/button[1]")).click();
		Thread.sleep(10000);
