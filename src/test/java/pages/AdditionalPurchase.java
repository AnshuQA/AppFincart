...
//Sell  
	    Thread.sleep(5000);
	    driver.findElement(By.xpath("/html/body/div[4]/md-dialog/md-dialog-content/md-tabs/md-tabs-wrapper/md-tabs-canvas/md-pagination-wrapper/md-tab-item[2]/span")).click();
	    Thread.sleep(3000);
...
//Cancel Button
   ...
   public void insurancePage() throws InterruptedException {
	   Thread.sleep(3000);
	   driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div/div/div/div[2]/div/md-card/md-card-header/md-card-header-media/div/button")).click();
	   Thread.sleep(3000);
	   driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div/div/div/div[2]/div/md-card/md-card-content/div/div/div[1]/div[5]/md-input-container/button/span")).click();
	   Thread.sleep(8000);
	   driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div/div/div/div[2]/div/md-card/md-card-content/div/div/div[3]/div[8]/div[1]/button")).click();
	   Thread.sleep(3000);
	   driver.findElement(By.xpath("//*[@id=\"dialogContent_32\"]/md-dialog-actions/button/span")).click();
	   Thread.sleep(3000);
	   driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div/div/div/div[2]/div/md-card/md-card-content/div/div/div[3]/div[8]/div[2]/button/span")).click();
	   Thread.sleep(3000);
	   driver.findElement(By.xpath("//*[@id=\"dialogContent_33\"]/md-dialog-actions/button")).click();
   }
 ...
 public void liquiLoanPage() throws InterruptedException {
	   Thread.sleep(3000);
	   driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div/div/div/div[2]/div/md-card/md-card-header/md-card-header-media/div/button/span")).click();
	   Thread.sleep(3000);
	   driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div/div/div/div[2]/div/md-card/md-card-content/div/div[2]/div[1]/md-input-container/button")).click();
	   Thread.sleep(12000);
	   driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div/div/div/div[2]/div/md-card/md-card-content/div/div[2]/div[2]/md-input-container/button")).click();
	   Thread.sleep(5000);
	   driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div/div/div/div[2]/div/md-card/md-card-content/div/div[2]/div[3]/md-input-container/button/span")).click();
